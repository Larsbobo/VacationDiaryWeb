...
const translations = {
  de: {
    ...
    featuresEyebrow: 'Für unterwegs gemacht', featuresTitle: 'Deine Reise, <em>dein Rhythmus.</em>',
    featuresText: 'Kein Feed, kein Lärm, kein Vergleichen. Nur du und die Momente, die du behalten möchtest.',
    featureOneTitle: 'Einfach festhalten', featureOneText: 'Notiere Gedanken, füge Fotos hinzu und gib jedem Eintrag deinen eigenen Ton.',
    featureTwoTitle: 'Orte wiederfinden', featureTwoText: 'Alle Lieblingsorte auf einen Blick. Deine persönliche Karte voller Geschichten.',
    featureThreeTitle: 'Erinnerungen bewahren', featureThreeText: 'Deine Sammlung wächst mit jedem Abenteuer und bleibt immer bei dir.',
  ...
  en: {
    ...
    featuresEyebrow: 'Made for the road', featuresTitle: 'Your journey, <em>your rhythm.</em>',
    featuresText: 'No feed, no noise, no comparing. Just you and the moments you want to keep.',
    featureOneTitle: 'Capture simply', featureOneText: 'Write down thoughts, add photos, and give every entry your own voice.',
    featureTwoTitle: 'Find your places', featureTwoText: 'All your favorite places at a glance. Your personal map full of stories.',
    featureThreeTitle: 'Keep the memories', featureThreeText: 'Your collection grows with every adventure and stays with you.',
